...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    homeTextFields.push(new DualLangeTextField('div1', `/luna/text/home/div1`, document.getElementById('div1-text')));
    homeTextFields.push(new DualLangeTextField('div2', `/luna/text/home/div2`, document.getElementById('div2-text')));
    homeTextFields.push(new DualLangeTextField('footer', `/luna/text/home/footer`, document.getElementById('footer-text')));
    homeTextFields.push(new DualLangeTextField( 'copyright',`/luna/text/home/copyright`, document.getElementById('copyright')));
